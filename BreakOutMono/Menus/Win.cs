...
namespace Breakout.Menus
{
    public class Win
    {
        ...
        public Win()
        {
            ...
            BlockGrey = Game1.Load.Load<Texture2D>("Images\\blocks\\YellowBlock");
        }
        ...
        public void Draw(GameTime gameTime)
        {
            ...
            Game1.spriteBatch.DrawString(UIFont, "Good On You", new Vector2(MenuScreen.X + 12, MenuScreen.Y + 8), Color.White);
            #endregion
